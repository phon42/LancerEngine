...
public class UnverifiedReserveData
    ...
    /**
     * The deployables associated with this reserve (i.e. an
     *     UnverifiedIDeployableData[] containing the 'Deployable Shield'
     *     ' (Reserve)' deployable).
     * Can be any UnverifiedIDeployableData[] that is not of length 0 or
     *     contains null elements. Can be null.
     */
