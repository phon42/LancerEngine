...
public class PilotGearUnverified extends PilotEquipmentUnverified {
    public PilotGearUnverified(
    ...
    public PilotGearUnverified(String id, String name, String type) {
        super(id, name, type);
    }
