...
public class UnverifiedFrame extends LicenseContent
    ...
    /**
     * Creates a deepest copy of the provided UnverifiedFrame.
     * @param frame an UnverifiedFrame to be copied.
    ...
    public UnverifiedFrame(UnverifiedFrame unverifiedFrame) {
        ...
        setMounts(unverifiedFrame.mounts);
        setCoreSystem(unverifiedFrame.coreSystem);
